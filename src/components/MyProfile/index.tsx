            ...
            <div className="editProfileModal_container">
                ...
                <form autoComplete={"off"} onSubmit={handleSubmit(onSubmitTryEditing)} className="editProfileModal_form">
                    <div style={{display:'flex',gap:'20px',width:'100%',position:'relative'}}>
                        <input style={{width:"100%"}} {...register('user_password',{required:{value:true,message:'Нажаль дані введені не корректно, перевірте їх та спробуйте ще раз!'}})} placeholder="Введіть теперішній пароль" className="input" type={passwordInputType}/>
