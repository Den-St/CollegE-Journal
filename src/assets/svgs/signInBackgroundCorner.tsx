export const signInBackgroundCorner = () => {
    return <svg className="cornerSvg" width="300" height="300" viewBox="0 0 300 300" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="299.5" y="0.5" width="299" height="299" transform="rotate(90 299.5 0.5)" fill="url(#paint0_linear_38_60)" stroke="url(#paint1_linear_38_60)"/>
        <defs>
