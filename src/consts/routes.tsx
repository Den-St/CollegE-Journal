...
export const PublicRoutes = [
    ...
    <Route key={routes.groups} element={<SecurityLevelGuard isActiveRequired securityLevel={securityLevels.admin}><Groups/></SecurityLevelGuard>} path={routes.groups}/>,    
    <Route key={routes.journal} element={<SecurityLevelGuard isActiveRequired securityLevel={securityLevels.admin}><Journal/></SecurityLevelGuard>} path={routes.journal}/>,
    ...
    <Route key={routes.pickJournalSubject} element={<SecurityLevelGuard isActiveRequired securityLevel={securityLevels.admin}><Subjects/></SecurityLevelGuard>} path={routes.pickJournalSubject}/>,
